...
const employesParProjet = {
  "projet-1": ["Jean Dupont", "Claire Fontaine", "Ali Ben"],
  "projet-2": ["Nina Simone", "Martin Leroy"]
};

// Données des compétences nécessaires pour chaque projet
const competencesParProjet = {
  "projet-1": ["Analyse des matériaux", "Maintenance industrielle", "Gestion de projet"],
  "projet-2": ["Négociation commerciale"]
};
